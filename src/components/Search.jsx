        ...
        <>
            <div className="container pb-20">
                ...
                <Grid container justifyContent="center">
                    {
                        data.length > 0 ?
                            <Pagination className={`${theme ? "text-white" : "text-dark"} `} page={current} onChange={handlePageChange} count={data.length / pageSize < 1 ? 1 : (data.length / pageSize)} rowsPerPage={pageSize} color="secondary"/>
                            :
