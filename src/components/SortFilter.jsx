...
function SortFilter() {
    ...
    return (
        <>
            <div className={`container ${theme ? "text-white" : "text-dark"} pb-20`}>
                <div className="container my-5">
                    <div className="row">
                        <div className="col-md-4">
                            ...
                            <div className="mt-5 mb-3">
                                ...
                                <ul class="list-group list-group-horizontal">
                                    <li class={`list-group-item border-0  ${theme ? "bg-dark text-white" : "bg-white text-dark"}`}>From:</li>
                                    <li class={`list-group-item border-0  ${theme ? "bg-dark" : "bg-white"}`}><input type="date" id="start_date"
                                        onChange={(e) => setStartDate(`release_date.gte=${e.target.value}`)} /></li>
                                </ul>
                                <ul class="list-group list-group-horizontal">
                                    <li class={`list-group-item border-0  ${theme ? "bg-dark text-white" : "bg-white text-dark"}`}>To:</li>
                                    <li class={`list-group-item border-0  ${theme ? "bg-dark" : "bg-white"}`}><input type="date" id="end_date"
                            ...
                            <div className="mt-5 mb-3">
                                ...
                                <label class={`btn me-3  ${theme ? "btn-outline-light" : "btn-outline-dark"}`} for="with_genres=28">Action</label>
                                <input type="checkbox" class="btn-check" onClick={genreButton} id="with_genres=12" autocomplete="off" />
                                <label class={`btn me-3  ${theme ? "btn-outline-light" : "btn-outline-dark"}`} for="with_genres=12">Adventure</label>
                                <input type="checkbox" class="btn-check" onClick={genreButton} id="with_genres=35" autocomplete="off" />
                                <label class={`btn me-3  ${theme ? "btn-outline-light" : "btn-outline-dark"}`} for="with_genres=35">Comedy</label>
                                <input type="checkbox" class="btn-check" onClick={genreButton} id="with_genres=10749" autocomplete="off" />
                                <label class={`btn me-3 mt-3  ${theme ? "btn-outline-light" : "btn-outline-dark"}`} for="with_genres=10749">Romance</label>
                                <input type="checkbox" class="btn-check" onClick={genreButton} id="with_genres=18" autocomplete="off" />
                                <label class={`btn me-3 mt-3  ${theme ? "btn-outline-light" : "btn-outline-dark"}`} for="with_genres=18">Drama</label>
                                <input type="checkbox" class="btn-check" onClick={genreButton} id="with_genres=80" autocomplete="off" />
                                <label class={`btn me-3 mt-3  ${theme ? "btn-outline-light" : "btn-outline-dark"}`} for="with_genres=80">Crime</label>
                            </div>
                            <div class="d-grid gap-2">
                                <button type="button" class={`btn mt-3 text-center ${theme ? "btn-light" : "btn-dark"}`} onClick={() => setSearch(true)}>Search</button>
                            </div>
                        </div>
                        ...
                        <div className="col-md-8 text-center">
                            ...
                            <button className={`btn ms-5 ${theme ? "btn-light" : "btn-dark"}`} onClick={showData}>Load More</button>
                        </div>
                    </div>
                </div>
            </div>
